...
newtype RdKafkaError = RdKafkaError CInt
...
errnoDesc :: IO String
errnoDesc = errnoToString <$> getErrno
...
withErrorBuffer :: (CStringLen -> IO a) -> IO a
withErrorBuffer = B.useAsCStringLen zeros
  where zeros = B.replicate 512 0